...
export const Navbar: React.FC<NavbarProps> = ({ onOpenResumeModal }) => {
  ...
  return (
    <>
      <header
        className={`fixed top-0 left-0 right-0 z-[200] w-full transition-transform duration-300 ease-in-out bg-[#FCFAF5] ${
          ...
          <div className="h-[64px] sm:h-[68px] md:h-[72px] flex items-center justify-between gap-3 sm:gap-4">
            ...
            <div className="hidden md:flex items-center shrink-0">
              <button
                ...
                className="h-[38px] sm:h-[40px] px-4 text-[13px] sm:text-[13.5px] font-semibold rounded-full bg-[#192841] text-white hover:bg-[#233758] hover:-translate-y-0.5 hover:shadow-[0_5px_15px_rgba(25,40,65,0.12)] transition-all duration-200 active:scale-[0.98] inline-flex items-center justify-center gap-1.5 shadow-xs group cursor-pointer"
              >
            ...
            <div className="flex md:hidden items-center shrink-0">
              <button
                ...
                className="w-[42px] h-[42px] rounded-xl bg-[#F5F1E8] border border-[#192841]/15 text-[#192841] hover:bg-[#F7E7CE] transition-colors focus:outline-none flex items-center justify-center shadow-2xs active:scale-95 cursor-pointer"
      ...
      {/* Full-Screen Top-Level Mobile Drawer Portal (Zero Stacking Context Interference) */}
      {mobileMenuOpen &&
        typeof document !== "undefined" &&
        createPortal(
          <div className="md:hidden fixed inset-0 top-[64px] sm:top-[68px] z-[190] bg-[#FCFAF5] flex flex-col justify-between overflow-y-auto px-5 py-6 border-t border-[#192841]/10 animate-in fade-in slide-in-from-top-1 duration-200">
            <div className="flex flex-col space-y-2.5 max-w-md mx-auto w-full">
              
              {/* 1. Navigation Links (100% Solid Full Width Rows) */}
              {navItems.map((item) => {
                const active = isItemActive(item.path);
                  ...
                  <Link
                    ...
                    className={`w-full min-h-[48px] px-4 py-3 rounded-xl flex items-center text-[16px] transition-all duration-200 ${
                      active
                        ...
                        : "text-[#192841] font-semibold bg-[#F5F1E8]/75 hover:bg-[#F5F1E8]"
                    }`}
                  >
              ...
              <div className="pt-2">
                <button
                  ...
                  className="w-full h-12 inline-flex items-center justify-center gap-2 px-4 text-[15px] font-bold rounded-xl bg-[#192841] text-white hover:bg-[#233758] transition-all shadow-sm active:scale-[0.99] cursor-pointer"
                >
