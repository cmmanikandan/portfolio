...
export const TechRadarOrbit: React.FC = () => {
  ...
  return (
    <div
      ...
      className="relative w-full max-w-[320px] sm:max-w-[380px] lg:max-w-[440px] aspect-square mx-auto flex items-center justify-center select-none p-3 sm:p-5 my-2"
      style={{
        perspective: "1000px"
      }}
    >
      ...
      >
        ...
        <div className="absolute w-44 h-44 sm:w-60 sm:h-60 rounded-full bg-[#F7E7CE]/60 blur-3xl -z-10 pointer-events-none" />
        <div className="absolute w-32 h-32 sm:w-44 sm:h-44 rounded-full bg-[#192841]/5 blur-2xl -z-10 pointer-events-none" />
        ...
        <div className="absolute inset-14 sm:inset-20 rounded-full border border-[#192841]/10 pointer-events-none" />
        ...
        <div
          className="absolute -top-1 left-0 sm:top-1 sm:left-1 z-20 px-2.5 py-1 sm:px-3 sm:py-1.5 rounded-xl sm:rounded-2xl bg-[#FFFEFB]/95 backdrop-blur-md border border-[#192841]/15 shadow-[0_6px_16px_rgba(25,40,65,0.08)] flex items-center gap-1.5 sm:gap-2 hover:border-[#192841]/35 transition-all duration-200"
          style={{
        ...
        <div
          className="absolute -top-1 right-0 sm:top-1 sm:right-1 z-20 px-2.5 py-1 sm:px-3 sm:py-1.5 rounded-xl sm:rounded-2xl bg-[#FFFEFB]/95 backdrop-blur-md border border-[#192841]/15 shadow-[0_6px_16px_rgba(25,40,65,0.08)] flex items-center gap-1.5 sm:gap-2 hover:border-[#192841]/35 transition-all duration-200"
          style={{
        ...
        <div
          className="absolute bottom-3 left-0 sm:bottom-4 sm:left-1 z-20 px-2.5 py-1 sm:px-3 sm:py-1.5 rounded-xl sm:rounded-2xl bg-[#FFFEFB]/95 backdrop-blur-md border border-[#192841]/15 shadow-[0_6px_16px_rgba(25,40,65,0.08)] flex items-center gap-1.5 sm:gap-2 hover:border-[#192841]/35 transition-all duration-200"
          style={{
        ...
        <div
          className="absolute bottom-3 right-0 sm:bottom-4 sm:right-1 z-20 px-2.5 py-1 sm:px-3 sm:py-1.5 rounded-xl sm:rounded-2xl bg-[#FFFEFB]/95 backdrop-blur-md border border-[#192841]/15 shadow-[0_6px_16px_rgba(25,40,65,0.08)] flex items-center gap-1.5 sm:gap-2 hover:border-[#192841]/35 transition-all duration-200"
          style={{
        ...
        <div className="absolute -bottom-2 sm:-bottom-3 left-1/2 -translate-x-1/2 z-30 px-3 py-1 rounded-full bg-[#192841] text-[#FCFAF5] border border-white/20 shadow-md flex items-center gap-1.5 text-[9px] sm:text-[10px] font-semibold whitespace-nowrap">
